...
4. **subagent-driven-development** or **executing-plans** - Activates with plan. Dispatches one implementer subagent for the plan, checks its work against the plan, then runs an adversarial whole-branch review; or executes in batches with human checkpoints.
